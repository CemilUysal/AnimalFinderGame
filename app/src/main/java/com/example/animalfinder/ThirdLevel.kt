...
class ThirdLevel : AppCompatActivity() {
    ...
    private fun getAnimal() {
        ...
        val controller = get_info.choose_animalList(4)
        // getting animal name for choosen images
        choosenAnimal = get_info.choose_one_Animal(4, controller)
    ...
    fun answer_controller(view: View) {
        ...
        if(view.getId() == R.id.image1 && txt == img1.tag.toString() ||
            ...
            // Doing this level must have 3 true answer point will be start 6
            if(point == 9){
                tts!!.speak("Congratulations", TextToSpeech.QUEUE_FLUSH, null, "")
                val intent = Intent(this, FourthLevel::class.java)
