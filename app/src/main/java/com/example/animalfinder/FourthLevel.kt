...
class FourthLevel : AppCompatActivity() {
    ...
    private fun getAnimal() {
        ...
        val controller = get_info.choose_animalList(6)
        // getting animal name for choosen images
        choosenAnimal = get_info.choose_one_Animal(6, controller)
    ...
    fun answer_controller(view: View) {
        ...
        if( view.getId() == R.id.image1 && txt == img1.tag.toString() ||
            ...
            // Doing this level must have 3 true answer point will be start 9
            if(point == 12){
                tts!!.speak("Congratulations", TextToSpeech.QUEUE_FLUSH, null, "")
                val intent = Intent(this, FifthLevel::class.java)
